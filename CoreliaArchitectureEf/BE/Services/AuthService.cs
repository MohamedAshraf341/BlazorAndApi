...
namespace BE.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<ResponseAuthDto> RegisterAsync(RegisterViewModel model)
        {
            ...
            return new ResponseAuthDto
            {
                ...
                Roles = new List<string> { RolesEnum.User.ToString() },
        ...
        public async Task<ResponseAuthDto> GetTokenAsync(LoginViewModel model)
        {
            ...
            var roleClaims = await GetClaims(rolesList.ToList());
            ...
            authModel.RoleClaims = roleClaims.Select(c => c.Value).ToList();
        ...
        private async Task<List<Claim>> GetClaims(List<string> roles)
        {
            var roleClaims = new List<Claim>();
            foreach (var role in roles)
            {
        ...
        {
            var rolesManagers = _roleManager.Roles.ToList();
            var roles=new List<Role>();
            foreach(var roleManager in rolesManagers)
            {
                roles.Add(new Role { Name = roleManager.Name });
            }
            return roles;
        }
    }
