...
namespace FE.UI.Services
{
    public class ApiClient : IDisposable
    {
        ...
        public ApiClient_Users Users { get => Get<ApiClient_Users>(); }
        ...
        public async Task<(bool, ResponseAuthDto)> CanLogin(string email, string password)
        {
            var loginResponse = await Users.Authenticate(email, password);
